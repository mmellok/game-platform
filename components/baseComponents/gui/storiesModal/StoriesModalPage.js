...
const StoriesModalPage = React.forwardRef(
  function StoriesModalPage({
    ...
    return (
      <div className={classNames("stories-modal__page", styles.storiesModal__page)} ref={ref}
           style={{
      ...
      >
        ...
        <div className={classNames("stories-modal__page-content", styles.storiesModal__pageContent)}>
          {title && <div className={classNames("stories-modal__page-title", styles.storiesModal__pageTitle)}>
            {safeHTML(title)}
          </div>}
          {text && <div className={classNames("stories-modal__page-text", styles.storiesModal__pageText)}>
            {safeHTML(text)}
          </div>}
        </div>
      </div>
