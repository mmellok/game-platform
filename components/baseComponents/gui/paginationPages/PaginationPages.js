...
export default function PaginationPages({className, children, itemsPerPage = 4}) {
  ...
  function Items({currentItems}) {
    return (
      <div className={classNames("pagination-page__items", styles.paginationPages__items)}>
  ...
  function PaginatedItems({itemsPerPage}) {
    ...
    return (
      <div className={classNames("pagination-pages", className, styles.paginationPages)}>
