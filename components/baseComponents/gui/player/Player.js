...
import button from "../../../../components/baseComponents/gui/CustomButton/CustomButton.module.scss";
  ...
  function Player({play, isActive, video, audio, openModal, type}, ref) {
    ...
    return (
      <div className={classNames( styles.player, {
        ...
        {video && <div className={classNames("player__content", styles.player__content)}>
        ...
        <div className={classNames(styles.player__controls)}>
          ...
          <div className={classNames( styles.player__buttons)}>
            <div className={classNames(  styles.player__buttonsBlock)}>
              ...
              <div ref={timeRef} className={classNames("player__time", styles.player__time)}>{"00:00/00:00"}</div>
            </div>
          </div>
        </div>
      </div>
