...
export default function CustomProgress(props) {
  const {value = .5, progressChanged, onChangeStarted, onChangeEnded, isVertical, hasDot,
    overrideClasses, onSeekStart, onSeekEnd} = props;
  ...
  return (
    <div
      ...
      tabIndex={"0"}>
      <div
        className={classNames(styles.customProgress__line)}
        ref={lineRef}
        role={"button"}
        tabIndex={"0"}
      >
