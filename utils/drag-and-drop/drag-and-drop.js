...
export default function dragAndDrop({target, onStartDrag, onDrag, onDrop, onDropReset, bounds, isResetOnDrop}) {
  let dragInfo = {};
  ...
  function stopDrag(e) {
    if (e && e.pointerId !== dragInfo.id) return;
    _stopDrag();
  }
